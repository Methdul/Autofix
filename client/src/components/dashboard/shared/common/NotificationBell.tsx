                        ...
                        {isLoading ? (
                            ...
                            notifications.map(notification => (
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-3 hover:bg-slate-800 transition-colors ${!notification.isRead ? 'bg-blue-600/5' : ''
                                        }`}
                                >
                                    <div className="flex items-start gap-3">
                                        {/* Unread indicator */}
                                        <div className={`mt-1.5 w-2 h-2 rounded-full flex-shrink-0 ${!notification.isRead ? 'bg-blue-500' : 'bg-transparent'
                                            }`} />
                                        <div className="flex-1 min-w-0">
                                            <p className={`text-sm font-medium leading-tight ${!notification.isRead ? 'text-slate-100' : 'text-slate-400'
                                                }`}>
                                                {notification.title}
                                            </p>
