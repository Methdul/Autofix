            ...
            <td className="py-4 px-6">
                <div className="flex flex-col gap-1.5">
                    ...
                    {booking.status === 'COMPLETED' && (
                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border w-fit ${booking.invoice?.status === 'PAID'
