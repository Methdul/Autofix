        ...
        <div className="flex min-h-screen bg-[#020617] text-slate-200">
            ...
            <main className="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
                ...
                <div className="p-8 max-w-5xl mx-auto w-full space-y-8 mb-10">
                    {message && (
                        <div className={`p-4 rounded-2xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300 ${message.type === 'success' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'
                            }`}>
